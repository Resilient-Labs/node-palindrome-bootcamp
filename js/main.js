document.querySelector('#clickMe').addEventListener('click', checkPalindrom)

function checkPalindrom(){

  const palindromHere = document.querySelector("#palindromHere").value;

  fetch(`/api?checkwords=${palindromHere}`)
