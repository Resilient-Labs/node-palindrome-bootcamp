...
const server = http.createServer(function (req, res) {
  ...
  if (page == "/") {
  ...
  } else if (page == "/imgs/evil.webp") {
    fs.readFile("imgs/evil.webp", function (err, data) {
    ...
    const palindromeResult = {
      ...
      checkPalindrome() {
        ...
        if (
          reversedWord.toLowerCase() === this.str.replace(" ", "").toLowerCase()
        ) {
          //we're re-assigning the result to the response string/message
          this.result = "Ding, ding, ding! It's a palindrome!";
        } else {
          this.result = "Sorry fam, try again next time!";
        }
      },
    };
